...
public class ExcepcionGlobalHandler extends BaseExceptionHandler{
    private static final String ERROR_INTERNO = "Ha ocurrido un error interno del sistema";

    @ExceptionHandler(Exception.class)
    public ResponseEntity<Map<String,String>> manejarExcepcionGlobal(Exception ex) {
        return construirRespuestaError(ERROR_INTERNO,HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
